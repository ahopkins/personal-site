...
const langColor = {
  ...
  CodeQL: { color: null, url: "https://github.com/trending?l=CodeQL" },
  CoffeeScript: {
    color: "#244776",
  ...
  TSQL: { color: null, url: "https://github.com/trending?l=TSQL" },
  TSX: { color: null, url: "https://github.com/trending?l=TSX" },
  Turing: {
    color: "#cf142b",
  ...
  V: { color: "#5d87bd", url: "https://github.com/trending?l=V" },
